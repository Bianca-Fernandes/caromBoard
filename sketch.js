...
function draw() {
  ...
  if (token5.x > 330 && token5.x < 350 && token5.y > 50 && token5.y < 70) {
    token5.x = -100;
    score++;
  }
  if (token5.x > 50 && token5.x < 70 && token5.y > 330 && token5.y < 350) {
    token5.x = -100;
    score++;
  }
  if (token5.x > 330 && token5.x < 350 && token5.y > 330 && token5.y < 350) {
    token5.x = -100;
    score++;
  }
  ...
  if (striker.x > 330 && striker.x < 350 && striker.y > 50 && striker.y < 70) {
    striker.x = 200;
    striker.y = 310;
    canFire = false;
    pushStrength=0;
  }
  if (striker.x > 50 && striker.x < 70 && striker.y > 330 && striker.y < 350) {
    striker.x = 200;
    striker.y = 310;
    canFire = false;
    pushStrength=0;
  }
  if (striker.x > 330 && striker.x < 350 && striker.y > 330 && striker.y < 350) {
    striker.x = 200;
    striker.y = 310;
    canFire = false;
    pushStrength=0;
